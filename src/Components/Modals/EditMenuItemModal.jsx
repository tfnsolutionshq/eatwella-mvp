...
const EditMenuItemModal = ({
  ...
  useEffect(() => {
    if (item) {
      setFormData({
        ...
        takeawayPack: item.takeawayPack ?? false,
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      data.append("takeawayPack", formData.takeawayPack);
      images.forEach((img) => {
              ...
              <div className="flex flex-col">
                <label className="flex items-center">
                  <input
                    ...
                    name="takeawayPack"
                    value={true}
                    checked={formData.takeawayPack === true}
                    onChange={() =>
                      setFormData({ ...formData, takeawayPack: true })
                    }
                    className="mr-1"
                    required
                  />
                ...
                <label className="flex items-center">
                  <input
                    ...
                    name="takeawayPack"
                    value={false}
                    checked={formData.takeawayPack === false}
                    onChange={() =>
                      setFormData({ ...formData, takeawayPack: false })
                    }
                    className="mr-1"
                    required
                  />
