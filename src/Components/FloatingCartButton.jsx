...
function FloatingCartButton() {
  ...
  return (
    <button
      ...
      className="fixed right-0 top-1/2 transform -translate-y-1/2 bg-orange-500 hover:bg-orange-600 text-white p-3 rounded-l-xl shadow-lg z-50 transition-colors flex flex-col items-center gap-1"
