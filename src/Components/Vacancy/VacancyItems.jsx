...
function VacancyItems() {
  ...
  const SkeletonCard = () => (
    <div className="bg-white rounded-[2rem] border border-gray-100 p-8 animate-pulse flex flex-col md:flex-row gap-6">
      {/* Image skeleton */}
      <div className="md:w-72 h-56 bg-gray-200 rounded-xl" />
        ...
        {loading ? (
          ...
          <div className="text-center py-24 bg-white rounded-[2.5rem] shadow-sm border border-gray-100">
            ...
            <p className="text-gray-500">
              We don't have any vacancies right now, but check back soon!
            </p>
          </div>
        ) : (
          <div className="grid gap-8 mb-12">
            {openings.map((opening) => (
              <div
                key={opening.id}
                className="group bg-white rounded-[2rem] shadow-sm hover:shadow-xl border border-gray-100/50 overflow-hidden transition-all duration-300 hover:-translate-y-1 flex flex-col md:flex-row"
              >
                {opening.image_path && (
            ...
            <div className="relative bg-orange-500 p-8 rounded-t-[2.5rem] overflow-hidden">
              ...
              <div className="relative z-10 flex justify-between items-start">
                <div className="text-white">
                  <h2 className="text-3xl font-bold font-bolota mb-2">
                    Apply Now
                  </h2>
