                ...
                <div className="flex flex-col md:flex-row justify-between gap-6">
                    ...
                    <div className="flex items-start justify-between">
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          <span
                            className={`text-xs px-2 py-0.5 rounded-full border font-medium capitalize ${getStatusColor(app.status)}`}
                          >
                  ...
                  <div className="flex flex-row md:flex-col justify-center gap-3 border-t md:border-t-0 md:border-l border-gray-100 pt-4 md:pt-0 md:pl-6 min-w-[200px]">
                    {app.cv_path ? (
                      ...
                      <button
                        disabled
                        className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-gray-50 text-gray-400 rounded-lg text-sm font-medium cursor-not-allowed"
                      >
                        <FiFileText className="w-4 h-4" />
                        No CV
                      </button>
