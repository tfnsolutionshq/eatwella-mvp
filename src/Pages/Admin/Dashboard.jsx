  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        console.log("the responses: ", summaryRes.data, topMenusRes.data, dailySalesRes.data);
  ...
  const stats = [
    {
      ...
      }).format(Math.ceil(summary?.total_revenue ?? 0)),
      icon: FiDollarSign,
      color: "bg-green-500",
    },
    {
    ...
    },
    {
      ...
      value: new Intl.NumberFormat("en-NG", {
        ...
        currency: "NGN",
        minimumFractionDigits: 0,
      }).format(Math.ceil(summary?.average_order_value ?? 0)),
      icon: FiTrendingUp,
      color: "bg-orange-500",
    },
  ];
      ...
      <div className="flex flex-col p-6 space-y-6 bg-gray-50/50 min-h-full">
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* Daily Sales Chart */}
            <div className="lg:col-span-2 min-w-0 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
