      ...
      <DashboardLayout>
        <div className="p-6 space-y-8 bg-gray-50/50 min-h-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
            {loading ? (
              [0, 1].map((_, i) => {
                const iconSkeletonColors = ["bg-orange-100", "bg-gray-200"];
                ...
                return (
                  ...
                  >
                    {/* Icon placeholder (color-matched) */}
                    <div
                      className={`w-10 h-10 rounded-xl mb-4 animate-pulse ${iconSkeletonColors[i]}`}
                    />
                  ...
                  {activeDiscounts.map((discount) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 pt-4 border-t border-gray-50">
                        <button
                          onClick={() =>
                            handleToggleActive(discount.id, discount.is_active)
                          }
                        ...
                        <button
                          ...
                          className="p-2 hover:bg-red-50 rounded-lg text-gray-400 hover:text-red-600 transition-colors border border-transparent hover:border-red-100"
                        >
              ...
              <div className="space-y-4 pt-4 border-t border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                  {inactiveDiscounts.map((discount) => (
                    <div
                      key={discount.id}
                      className="bg-gray-50 rounded-2xl border border-gray-200 p-6 flex flex-col opacity-75"
                    >
                      <div className="flex justify-between items-start mb-4">
                      ...
                      <div className="flex items-center gap-3 pt-4 border-t border-gray-200">
                        <button
                          ...
                          className="flex-1 px-4 py-2 bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 rounded-lg text-sm font-medium transition-colors"
                        >
                          Reactivate
                        </button>
                        <button
