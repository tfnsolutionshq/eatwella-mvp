...
const SingleUser = () => {
  ...
  const formatOrderType = (orderType) => {
    if (!orderType) return "";
    if (orderType === "dine") return "Dine-In";
  ...
  if (loading) {
    return (
      <DashboardLayout>
        <div className="flex flex-col items-center justify-center py-32 gap-4 h-screen">
                ...
                {agentOrdersLoading ? (
                  ...
                  <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 text-center">
                    ...
                    <p className="text-gray-500">
                      Please select a date to search orders
                    </p>
                  </div>
                  ...
                  <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 text-center">
                    <FiCalendar className="w-12 h-12 text-gray-300 mx-auto mb-3" />
                    <p className="text-gray-500">
                      Please select both from and to dates to search orders
                    </p>
                  </div>
                      ...
                      >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-600">
                              {order.delivery_zone?.city?.state?.name},{" "}
                              {order.delivery_zone?.city?.name}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between pt-3 border-t border-gray-200">
                          <div className="text-xs text-gray-500">
                            ...
                            • Assigned:{" "}
                            {new Date(order.assigned_at).toLocaleTimeString(
                              "en-US",
                              {
                                hour: "2-digit",
                                minute: "2-digit",
                    ...
                    {agentOrders.orders.last_page > 1 && (
                      <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                        <div className="text-sm text-gray-500">
                          Showing {agentOrders.orders.from}-
                          {agentOrders.orders.to} of {agentOrders.orders.total}{" "}
                          orders
                        </div>
                        <div className="flex items-center gap-2">
                          <button
                            onClick={() =>
                              handlePageChange(
                                agentOrders.orders.current_page - 1,
                              )
                            }
                          ...
                          <span className="text-sm text-gray-600 px-2">
                            Page {agentOrders.orders.current_page} of{" "}
                            {agentOrders.orders.last_page}
                          </span>
                          <button
                            onClick={() =>
                              handlePageChange(
                            ...
                            disabled={
                              agentOrders.orders.current_page ===
                              agentOrders.orders.last_page
                            }
                            className="px-3 py-1.5 rounded-lg text-sm font-medium border border-gray-200 text-gray-600 hover:bg-gray-100 transition disabled:opacity-50 disabled:cursor-not-allowed"
                          >
